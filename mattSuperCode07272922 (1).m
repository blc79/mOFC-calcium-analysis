...
b2=[];
    for j=1:d
        ...
        a=dffCellsOnly((cellTrace_TrialStartIdx(j)-pre):(cellTrace_TrialStartIdx(j)+post),i);
        b= dffCellsOnly((cellTrace_TrialStartIdx(j)-pre):(cellTrace_TrialStartIdx(j)-pre2),i);
        t=[t,a];
        b2=[b2,b];
    end
